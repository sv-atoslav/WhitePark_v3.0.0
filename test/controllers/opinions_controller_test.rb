...
class OpinionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create opinion" do
    assert_difference('Opinion.count') do
      post opinions_url, params: { opinion: { author: @opinion.author, visit: @opinion.visit, words: @opinion.words } }
    end
  ...
  test "should update opinion" do
    patch opinion_url(@opinion), params: { opinion: { author: @opinion.author, visit: @opinion.visit, words: @opinion.words } }
